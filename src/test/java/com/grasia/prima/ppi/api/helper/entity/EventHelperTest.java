...
class EventHelperTest {
    ...
    @Test
    void testInstanceEventHelper() throws NoSuchMethodException {
        Constructor<EventHelper> constructor = EventHelper.class.getDeclaredConstructor();
    ...
    @Test
    void testToEventResponse_EventIsNull() {
        EventResponse response = EventHelper.toEventResponse(null);
        assertNull(response);
    }
}